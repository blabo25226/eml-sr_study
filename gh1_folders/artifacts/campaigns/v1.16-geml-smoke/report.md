# EML Benchmark Campaign Report: geml-v116-smoke

Cheap v1.16 smoke campaign with generic i*pi primitive initializers and negative-control visibility.
...
```bash
PYTHONPATH=src python -m eml_symbolic_regression.cli campaign geml-v116-smoke --output-root artifacts/campaigns --label v1.16-geml-smoke --overwrite
```

- Suite: `v1.16-geml-smoke`
- Budget tier: `v1.16-geml`
- Guardrail: 4 configured cases; sin(pi*x) and exp each paired across raw EML and i*pi EML.
- Raw run artifacts: [runs/v1.16-geml-smoke](runs/v1.16-geml-smoke)
...
This campaign measures the current pure random-initialized blind boundary: 0/4 blind runs are trained exact recoveries, including 0 threshold-eligible pure blind recoveries, plus 1 repaired candidate. These rows are recovery-boundary evidence, not warm-start exact-return evidence.
...
- Failed fits: 3 runs did not pass verifier-owned recovery after training or execution.

## Failed and Unsupported Cases

| Formula | Mode | Class | Reason | Artifact |
|---------|------|-------|--------|----------|
| sin_pi | blind | snapped_but_failed | train_failed | [v1-16-geml-smoke-sin-pi-raw-v116-blind-7e3efe6e564e](runs/v1.16-geml-smoke/v1-16-geml-smoke-sin-pi-raw-v116-blind-7e3efe6e564e.json) |
| sin_pi | blind | snapped_but_failed | train_failed | [v1-16-geml-smoke-sin-pi-ipi-v116-blind-e7efd47e48bd](runs/v1.16-geml-smoke/v1-16-geml-smoke-sin-pi-ipi-v116-blind-e7efd47e48bd.json) |
| exp | blind | snapped_but_failed | train_failed | [v1-16-geml-smoke-exp-ipi-v116-blind-e8fe36239cff](runs/v1.16-geml-smoke/v1-16-geml-smoke-exp-ipi-v116-blind-e8fe36239cff.json) |
