...
```bash
PYTHONPATH=src python -m eml_symbolic_regression.cli campaign paper-tracks --output-root artifacts/paper/v1.14/linked-artifacts/campaigns --label v1.14-corrected-paper-tracks --overwrite
```
...
| Median runtime seconds | 0.02734 |
...
|-----|----------|--------------------|------------|---------------|----------------|-------------|------------|
| v1-13-paper-tracks-exp-literal-warm-9b23eed6fa6a | exact_seed_round_trip | 0.0 | 1 | 1 | 1 |  | same_ast |
| v1-13-paper-tracks-log-literal-warm-682593206b87 | unsupported | 0.0 | 1 | 1 | 1 |  | unsupported |
| v1-13-paper-tracks-radioactive-decay-literal-warm-2c95fb8d28a3 | exact_seed_round_trip | 0.0 | 1 | 1 | 1 |  | same_ast |
| v1-13-paper-tracks-beer-lambert-literal-warm-6bde0341b85f | exact_seed_round_trip | 0.0 | 1 | 1 | 1 |  | same_ast |
| v1-13-paper-tracks-scaled-exp-growth-literal-warm-de37e614d838 | exact_seed_round_trip | 0.0 | 1 | 1 | 1 |  | same_ast |
| v1-13-paper-tracks-scaled-exp-fast-decay-literal-warm-2ec985eec55a | exact_seed_round_trip | 0.0 | 1 | 1 | 1 |  | same_ast |
| v1-13-paper-tracks-arrhenius-literal-warm-b1aea4d7678e | exact_seed_round_trip | 0.0 | 1 | 1 | 1 |  | same_ast |
| v1-13-paper-tracks-michaelis-menten-literal-warm-a45fcb5297df | exact_seed_round_trip | 0.0 | 1 | 1 | 1 |  | same_ast |
| v1-13-paper-tracks-logistic-literal-warm-9ea281dbf3ec | unsupported | 0.0 | 1 | 1 | 1 |  | unsupported |
| v1-13-paper-tracks-shockley-literal-warm-99701f065be5 | exact_seed_round_trip | 0.0 | 1 | 1 | 1 |  | same_ast |
| v1-13-paper-tracks-damped-oscillator-literal-warm-4ac09e7e05b3 | unsupported | 0.0 | 1 | 1 | 1 |  | unsupported |
| v1-13-paper-tracks-planck-literal-warm-00693e8cb013 | unsupported | 0.0 | 1 | 1 | 1 |  | unsupported |
