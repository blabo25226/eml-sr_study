...
| Planck diagnostic | `x**3/(exp(x) - 1)` | unsupported | 14 | low_degree_power_template, scaled_exp_minus_one_template, direct_division_template | not_applicable | unsupported | compile_only | artifacts/campaigns/v1.10-planck-diagnostics/v1-10-planck-diagnostics-planck-compile-795067919a97.json |
| Logistic diagnostic | `1/(1 + 2*exp(-1.3*x))` | unsupported | 15 | exponential_saturation_template | not_applicable | unsupported | compile_only | artifacts/campaigns/v1.10-logistic-evidence/v1-10-logistic-evidence-logistic-compile-c2af27a35e81.json |
