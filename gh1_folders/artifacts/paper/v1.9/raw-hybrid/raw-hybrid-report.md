...
| Source | Run | Formula | Mode | Evidence Class | Status | Artifact |
|--------|-----|---------|------|----------------|--------|----------|
| v1.6-logistic-diagnostic-run | v1-3-standard-logistic-compile-a99c41f57b97 | logistic | compile | unsupported | unsupported | artifacts/campaigns/v1.6-standard/runs/v1.3-standard/v1-3-standard-logistic-compile-a99c41f57b97.json |
| v1.6-planck-diagnostic-run | v1-3-standard-planck-diagnostic-2309e6363fc8 | planck | compile | unsupported | unsupported | artifacts/campaigns/v1.6-standard/runs/v1.3-standard/v1-3-standard-planck-diagnostic-2309e6363fc8.json |
