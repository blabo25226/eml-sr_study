...
```bash
PYTHONPATH=src python -m eml_symbolic_regression.cli campaign proof-shallow --output-root artifacts/proof/v1.5/campaigns --label proof-shallow --overwrite
```
